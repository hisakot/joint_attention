...
class VisionTransformer(nn.Module):
    def __init__(self, in_channels, patch_size, emb_size, img_H, img_W, num_layers, num_heads, forward_expansion, num_classes):
        ...
        self.deconv1 = nn.ConvTranspose2d(128, 64, kernel_size=3, stride=2, padding=0)
        self.deconv_bn1 = nn.BatchNorm2d(64)
        self.deconv2 = nn.ConvTranspose2d(64, 32, kernel_size=3, stride=2, padding=0)
        self.deconv_bn2 = nn.BatchNorm2d(32)
        self.deconv3 = nn.ConvTranspose2d(32, 16, kernel_size=3, stride=2, padding=0)
        self.deconv_bn3 = nn.BatchNorm2d(16)
        self.deconv4 = nn.ConvTranspose2d(16, 4, kernel_size=3, stride=4, padding=0)
        self.deconv_bn4 = nn.BatchNorm2d(4)
        self.deconv5 = nn.ConvTranspose2d(4, 1, kernel_size=3, stride=4, padding=0)
